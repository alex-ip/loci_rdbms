select feature1,
round(sum(feature2_proportion * dwellings)) as dwellings,
round(sum(feature2_proportion * population)) as population
--dwellings as feature2_dwellings,
--population as feature2_population
from (
SELECT *,
CASE 
